    ...
    <div class="card">
        <div class="card-body">
            <form class="form-inline" method="POST" action="{{ route('update-user',['id'=>$user->id]) }}" enctype="multipart/form-data">
                ...
                <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Enter your family" style="color: white;" name="family" value="{{ old('family',$user->family) }}">

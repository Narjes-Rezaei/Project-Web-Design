...
<script>
    ...
    function removeUser(user_id) {
        ...
        request.open("GET", `/remove-member/${user_id}`, true);
            ...
            <div class="card-body">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 mb-3">
                    ...
                    <div class="flex-grow-1 d-flex justify-content-md-end justify-content-center">
                        @can('add-members-team')
                        <a href="{{ route('add-member') }}" class="btn btn-success">+ Add Member</a>
                        @endcan
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ $member->image ? asset('memberProfile/'.$member->image) : asset('userProfile/profile.png')}}" alt="image">
                                </td>

    ...
    <div class="card">
        <div class="card-body">
            <form class="form-inline" method="POST" action="{{ route('update-user',['id'=>$user->id]) }}" enctype="multipart/form-data">
                ...
                <label class="sr-only" for="inlineFormInputName2">Number Of Team</label>
                <input type="numberOfTeam" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="3" style="color: white;" name="number_of_team" value="{{ old('phone',$user->phone) }}">
                ...
                <p>Old Photo</p>
                <img src="{{ $user->photo ? asset('teamLogo/'.$user->photo) : asset('teamLogo/profile.png')}}" alt="Old Photo" style="max-width: 150px; max-height: 150px; border: 1px solid #ccc; border-radius: 8px; object-fit: cover;">
                <br>
                <br>

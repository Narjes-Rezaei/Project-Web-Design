                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="{{ route('show-details',['id'=>$match->id]) }}">
                                            <button type="button" class="btn btn-outline-primary">Show Details</button>
                                        </a>
                                        <a href="{{ route('match-referee',['id'=>$match->id]) }}">
                                            <button type="button" class="btn btn-outline-info">Show Referee</button>
                                        </a>
                                        <a href="{{ route('team-match',['id'=>$match->id]) }}">
                                            <button type="button" class="btn btn-outline-info">Show Team</button>
                                        </a>
                                    </div>
                                </td>
                            </tr>

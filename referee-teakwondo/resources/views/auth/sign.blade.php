...
<body>
                ...
                <div class="col-12 text-center align-self-center py-5">
                    <div class="section pb-5 pt-5 pt-sm-2 text-center">
                        ...
                        <input
                            ...
                            name="reg-log"
                            aria-hidden="true" />
                        <label for="reg-log" aria-hidden="true"></label>

                        <div
                            class="card-3d-wrap mx-auto"
                            role="region"
                                ...
                                <div class="card-back" aria-hidden="true">
                                    <div class="center-wrap">
                                        <div class="signup-section text-center">
                                            ...
                                            <!-- Signup form -->
                                            <form id="signupForm" class="signup-form" autocomplete="on" novalidate>
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    <i class="input-icon uil uil-phone" aria-hidden="true"></i>
                                                    <input
                                                        type="tel"
                                                        name="phone"
                                                        id="signup_phone"
                                                ...
                                                <div class="form-group">
                                                    <i class="input-icon uil uil-image" aria-hidden="true"></i>
                                                    <input
                                                        type="file"
                                                        name="photo"
                                                        id="signup_photo"
                                                ...
                                                <div class="form-group mt-4">
                                                    <button type="submit" class="btn" id="signupSubmit" aria-label="Submit signup">
                                                        Submit
                                                    </button>
                                                </div>
                                            </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // اضافه کردن قابلیت کلیک روی دکمه Sign Up برای رفتن به فرم ثبت نام
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        if (data.errors) {
                            ...
                            showMessage(signupMessage, errors, 'error');
                        }
                    }
                } catch (error) {
            ...
            loginForm.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        if (data.errors) {
                            const errors = Object.values(data.errors).flat().join('<br>');
                            showMessage(loginMessage, errors, 'error');
                        }
                    }
                } catch (error) {
                    console.error('Error:', error);
            ...
            const photoInput = document.getElementById('signup_photo');
            photoInput.addEventListener('change', function() {
                if (this.files && this.files[0]) {
                    const fileName = this.files[0].name;
                    // می‌توانید نام فایل را در جایی نمایش دهید اگر نیاز باشد
